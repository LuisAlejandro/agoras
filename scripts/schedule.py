...
msg = "Have you heard of Agoras, a command line python utility to manage your social networks?"

creds = Credentials.from_service_account_info(account_info, scopes=gspread_scope)
...
if google_sheets_name == "Youtube":
    worksheet.append_row(
        [msg, "https://luisalejandro.org/blog/posts/nuevo-blog", "", "", "", "", currdate, currhour, "draft"],
        table_range="A1",
    )
