...
class TwitterAPIClient:
    """
    Twitter API client that centralizes both v1.1 and v2 API operations.

    Handles all Twitter API interactions including authentication, media upload,
    ...
    def _verify_credentials(self):
        """
        Verify Twitter credentials using v1 API.
