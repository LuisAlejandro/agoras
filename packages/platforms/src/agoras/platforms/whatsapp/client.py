...
class WhatsAppAPIClient:
    ...
    def send_document(self, to: str, document_url: str, caption: Optional[str] = None, filename: Optional[str] = None) -> Dict[str, Any]:
        """
        Send document/file message via Graph API.
        ...
        try:
            ...
            raise Exception(f'WhatsApp send_document failed: {str(e)}')

    def send_audio(self, to: str, audio_url: str) -> Dict[str, Any]:
        """
        Send audio message via Graph API.
        ...
        try:
            ...
            raise Exception(f'WhatsApp send_audio failed: {str(e)}')

    def send_contact(self, to: str, contacts: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        Send contact card message via Graph API.

        Args:
            to (str): Recipient phone number in E.164 format (e.g., +1234567890)
            contacts (list): List of contact dictionaries with name and phone information
        ...
        try:
            ...
            raise Exception(f'WhatsApp send_contact failed: {str(e)}')
    ...
    def send_location(self, to: str, latitude: float, longitude: float, name: Optional[str] = None, address: Optional[str] = None) -> Dict[str, Any]:
        """
        Send location message via Graph API.
        ...
        try:
            ...
            raise Exception(f'WhatsApp send_location failed: {str(e)}')

    def send_template(self, to: str, template_name: str, language_code: str = "en", components: Optional[List[Dict]] = None) -> Dict[str, Any]:
        """
