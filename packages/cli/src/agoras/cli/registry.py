...
class PlatformRegistry:
    ...
    PLATFORMS: Dict[str, Dict[str, Any]] = {
        "x": {
            ...
            "actions": {"authorize", "post", "video", "thread", "like", "share", "delete", "reply"},
        ...
        "facebook": {
            ...
            "actions": {"authorize", "post", "video", "like", "share", "delete", "reply"},
            "module": "agoras.cli.platforms.facebook",
        },
        "instagram": {
            "name": "Instagram",
            "description": "Instagram social network",
            "actions": {"authorize", "post", "video", "reply"},
        ...
        "discord": {
            ...
            "actions": {"authorize", "post", "video", "thread", "delete", "reply"},
            "module": "agoras.cli.platforms.discord",
        },
        "youtube": {
            "name": "YouTube",
            "description": "YouTube video platform",
            "actions": {"authorize", "video", "like", "delete", "reply"},
