...
def test_format_linkedin_exports_access_token_and_optional_refresh_token(temp_storage):
    ...
    assert output is not None
    assert "LINKEDIN_OBJECT_ID=user-123" in output
    assert "LINKEDIN_CLIENT_ID=client-456" in output
    assert "LINKEDIN_REFRESH_TOKEN=refresh-token" in output
    ...
    output_standard = format_unattended_env(temp_storage)

    assert output_standard is not None
    assert "LINKEDIN_OBJECT_ID=user-123" in output_standard
    assert "LINKEDIN_CLIENT_ID=client-456" in output_standard
    assert "LINKEDIN_REFRESH_TOKEN=" in output_standard
    assert "LINKEDIN_ACCESS_TOKEN=access-token" in output_standard
