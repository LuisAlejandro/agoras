...
CI probe v9 (auto-merge validation)
-----------------------------------

Temporary marker for probe v9: retains a non-zero diff if the probe test file
is removed by Cursor automation (repeat validation after v8 success).
