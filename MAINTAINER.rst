...
CI probe v8 (auto-merge validation)
-----------------------------------

Temporary marker for probe v8: retains a non-zero diff if the probe test file
is removed by Cursor automation (Checks completed trigger + MCP dispatch).
